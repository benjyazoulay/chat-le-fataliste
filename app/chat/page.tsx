...
import {
    STYLE_DESCRIPTIONS, PERSONALITY_DESCRIPTIONS, GENRE_DESCRIPTIONS,
    NARRATOR_RELATION_DESCRIPTIONS, FOCALIZATION_DESCRIPTIONS,
    PERSON_DESCRIPTIONS, TENSE_DESCRIPTIONS
} from "@/components/ui/settings-form"; // Assuming constants are exported or accessible
